<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Add Admin User</h3>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
	...
	<div class="col-lg-12">	
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">									
					<form role="form" action="<?php echo base_url('new-user'); ?>" method="POST" name="new_user_form" id="new_user_form">	
						<div class="col-lg-12">	
							<div class="col-lg-6">			
						...
						<div class="col-lg-12">	
							<div class="col-lg-6">	
								<button type="submit" name="new_user_button" id="new_user_button" class="btn btn-sm btn-outline btn-primary">Save</button>
...
<script type="text/javascript">
	...
	$(document).ready( function() {
		...
		$('#new_user_button').on('click', validateNewOrderForm); 
		$('#new_user_form').on('submit', validateNewOrderForm); 
			...
			$('#new_user_form').validate({		
				rules: {
					...
					email: { 
						...
						email : true,
						remote: {
							url: "<?php echo base_url('check-email-user') ?>",
							type: "get"
						}
					 },
